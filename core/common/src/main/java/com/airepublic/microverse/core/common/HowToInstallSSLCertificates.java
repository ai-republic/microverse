 ...
 * 
 * <p>
 * Use JDK keytool utility to import a trusted certificate and generate a truststore file: <pre>
 ...
 * <pre>keytool -genkey -v -alias "my client key" -validity 365 -keystore my.keystore</pre> For simplicity use the same
 * password for the key as that of the keystore
 * </p>
 * </li>
 * <li>
 * <p>
 ...
 * <li>
 * <p>
 * Verify the content the resultant keystore file <pre>keytool -list -v -keystore my.keystore</pre>
 * </p>
 * </li>
 * </ul>
 * <p>
 * Example of using custom protocol socket factory for a specific host: <pre>
 ...
 * </p>
 * <p>
 * Example of using custom protocol socket factory per default instead of the standard one: <pre>
 *     Protocol authhttps = new Protocol("https",  
 *          new AuthSSLProtocolSocketFactory(
 *              new URL("file:my.keystore"), "mypassword",
 *              new URL("file:my.truststore"), "mypassword"), 443); 
...
public class HowToInstallSSLCertificates {}
...
// * @param keystorePassword Password to unlock the keystore. IMPORTANT: this implementation assumes that the same
// * password is used to protect the key and the keystore itself.
// * @param truststoreUrl URL of the truststore file. May be <tt>null</tt> if HTTPS server authentication is not to be
// * used.
...
// final KeyStore keystore = createKeyStore(this.keystoreUrl, this.keystorePassword);
...
// final KeyStore keystore = createKeyStore(this.truststoreUrl, this.truststorePassword);
// if (LOG.isDebugEnabled()) {
// final Enumeration aliases = keystore.aliases();
// while (aliases.hasMoreElements()) {
// final String alias = (String) aliases.nextElement();
